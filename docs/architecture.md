...
Status: **GUI rebuild through M6 of the CapCut-class editor plan.** Export drives
...
dialog with progress bar / ETA / cancel (M6). Thumbnails/waveforms are M4. macOS/Linux
